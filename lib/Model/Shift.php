...
class Shift implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'label' => 'string',
        'revenues' => '\OpenAPI\Client\Model\ShiftRevenues',
        'revenue' => 'int',
        'breaks' => '\OpenAPI\Client\Model\Period[]',
        'tags' => 'string[]',
        'required_skills' => 'string[]',
        'assignment' => '\OpenAPI\Client\Model\ShiftAssignment',
    ...
    */
     ...
     * Gets revenues
     *
     * @return \OpenAPI\Client\Model\ShiftRevenues|null
     */
     ...
     * Sets revenues
     *
     * @param \OpenAPI\Client\Model\ShiftRevenues|null $revenues revenues
     *
     * @return self
     */
     ...
     * Sets breaks
     *
     * @param \OpenAPI\Client\Model\Period[]|null $breaks Unpaid break periods during the shift (lunch, rest breaks). Breaks are subtracted from total shift duration to calculate actual work time. Must be entirely within the shift timeframe.
     *
     * @return self
     */
     ...
     * Gets assignment
     *
     * @return \OpenAPI\Client\Model\ShiftAssignment|null
     */
     ...
     * Sets assignment
     *
     * @param \OpenAPI\Client\Model\ShiftAssignment|null $assignment assignment
     *
     * @return self
     */
