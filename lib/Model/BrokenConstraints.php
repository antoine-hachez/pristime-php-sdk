...
class BrokenConstraints implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets warnings
     *
     * @param string[]|null $warnings List of soft constraint violations. These are less critical violations of preferences or flexible rules that were relaxed to find a feasible solution.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param string[]|null $errors List of hard constraint violations. These are serious violations that prevented the optimization from finding a feasible solution.
     *
     * @return self
     */
