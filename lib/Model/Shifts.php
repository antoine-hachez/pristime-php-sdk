 ...
 */
class Shifts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Shifts';
    ...
    protected static $openAPITypes = [
        'provided' => 'array<string,\OpenAPI\Client\Model\ShiftAssignmentResult>',
        'created' => '\OpenAPI\Client\Model\Shift[]'
    ];
    ...
    */
     ...
     * Gets provided
     *
     * @return array<string,\OpenAPI\Client\Model\ShiftAssignmentResult>
     */
     ...
     * Sets provided
     *
     * @param array<string,\OpenAPI\Client\Model\ShiftAssignmentResult> $provided Assignment results for shifts you provided in the request, keyed by your original shift IDs. Shows which worker (if any) is now assigned to each existing shift.
     *
     * @return self
     */
     ...
     * Gets created
     *
     * @return \OpenAPI\Client\Model\Shift[]
     */
     ...
     * Sets created
     *
     * @param \OpenAPI\Client\Model\Shift[] $created New shifts automatically created by the optimization algorithm to meet staffing demands. These are additional shifts beyond what you originally provided, always with assigned workers.
     *
     * @return self
     */
