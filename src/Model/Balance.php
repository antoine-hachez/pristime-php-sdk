...
class Balance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('current_minutes', $data ?? [], 0);
    }
    ...
    */
     ...
     * Sets min_minutes
     *
     * @param int $min_minutes Minimum allowed balance in minutes (smallest value allowed). Prevents excessive time debt to workers.
     *
     * @return self
     */
     ...
     * Sets max_minutes
     *
     * @param int $max_minutes Maximum allowed balance in minutes (largest value allowed). Prevents excessive time debt from workers.
     *
     * @return self
     */
     ...
     *
     * @param int|null $current_minutes Current accumulated balance in minutes. Positive = worker has worked more than expected, negative = worker has worked less than expected.
     *
     * @return self
     */
