 ...
 */
class MaxConsecutiveWorkdays implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaxConsecutiveWorkdays';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['preferred'] < 1)) {
            $invalidProperties[] = "invalid value for 'preferred', must be bigger than or equal to 1.";
        }

        if ($this->container['absolute'] === null) {
            $invalidProperties[] = "'absolute' can't be null";
        }
        if (($this->container['absolute'] < 1)) {
            $invalidProperties[] = "invalid value for 'absolute', must be bigger than or equal to 1.";
        }
     ...
     * Sets preferred
     *
     * @param int $preferred Target maximum consecutive workdays. The optimizer tries to stay within this limit but may exceed it to meet critical staffing needs.
     *
     * @return self
     */
    public function setPreferred($preferred)
    {
        ...
        if (($preferred < 1)) {
            throw new \InvalidArgumentException('invalid value for $preferred when calling MaxConsecutiveWorkdays., must be bigger than or equal to 1.');
        }
     ...
     * Sets absolute
     *
     * @param int $absolute Hard maximum consecutive workdays that cannot be exceeded under any circumstances. Must be >= preferred maximum.
     *
     * @return self
     */
    public function setAbsolute($absolute)
    {
        ...
        if (($absolute < 1)) {
            throw new \InvalidArgumentException('invalid value for $absolute when calling MaxConsecutiveWorkdays., must be bigger than or equal to 1.');
        }
