 ...
 */
class ShiftRevenues implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShiftRevenues';
    ...
    {
        $this->setIfExists('per_assigned_hour', $data ?? [], 100);
        $this->setIfExists('continuity_revenue', $data ?? [], 0);
    }
    ...
    */
     ...
     *
     * @param int|null $per_assigned_hour Revenue value per work hour for optimization calculations. Higher values make this shift more attractive for assignment.
     *
     * @return self
     */
     ...
     *
     * @param int|null $continuity_revenue Bonus revenue when this shift is assigned to the same worker as its preceding shift. Encourages consistent worker assignment for shift sequences.
     *
     * @return self
     */
