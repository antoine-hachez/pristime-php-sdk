 ...
 */
class ShiftAssignmentResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShiftAssignmentResult';
    ...
    protected static $setters = [
        ...
        'previous_worker_id' => 'setPreviousWorkerId'
    ];
    ...
    protected static $getters = [
        ...
        'previous_worker_id' => 'getPreviousWorkerId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('previous_worker_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets worker_id
     *
     * @param string|null $worker_id worker_id
     *
     * @return self
     */
    public function setWorkerId($worker_id)
    {
        if (is_null($worker_id)) {
            array_push($this->openAPINullablesSetToNull, 'worker_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('worker_id', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets previous_worker_id
     *
     * @return string|null
     */
    public function getPreviousWorkerId()
    {
        return $this->container['previous_worker_id'];
    }

    /**
     * Sets previous_worker_id
     *
     * @param string|null $previous_worker_id previous_worker_id
     *
     * @return self
     */
    public function setPreviousWorkerId($previous_worker_id)
    {
        if (is_null($previous_worker_id)) {
            array_push($this->openAPINullablesSetToNull, 'previous_worker_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('previous_worker_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['previous_worker_id'] = $previous_worker_id;
