 ...
 */
class TagCount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TagCount';
    ...
    */
     ...
     * Sets since_date
     *
     * @param \DateTime $since_date The date from which we started counting the number of shifts with this tag.
     *
     * @return self
     */
    public function setSinceDate($since_date)
    {
        if (is_null($since_date)) {
            throw new \InvalidArgumentException('non-nullable since_date cannot be null');
        }
     ...
     * Sets count
     *
     * @param int $count The number of shifts with this tag on the scheduling start date.
     *
     * @return self
     */
